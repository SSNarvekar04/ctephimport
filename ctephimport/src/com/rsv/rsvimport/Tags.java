 ...
 * This class provides tag constants.
 *
...
public class Tags {
   ...
   public static void main(String args[]){
      // System.out.println(valueOf("(0000,0900)"));
	       ...
	       try {
	           ...
	           tagsmap.put((Integer)field.get(null),field.getName());
                       System.out.println((Integer)field.get(null)+"=="+Tags.toString((Integer)field.get(null))+"=="+valueOf(Tags.toString((Integer)field.get(null)))+"===="+field.getName());
	...
	/*    //   return tagsmap;
       ...
       try {
           for (int i = 0; i < fields.length; i++) {
           Field field = fields[i];
           if(field.getName().toUpperCase().equals(tag) || true){
                       tagsmap.put((Integer)field.get(tagsInstance),field.getName());
                       System.out.println(Tags.toString((Integer)field.get(tagsInstance)));
       ...
       for (Map.Entry<Integer, String> entry : tagsmap.entrySet()) {
         ...
         //  System.out.println(objectInstance1.valueOf(value));
